...
export const services = [
  {
    title: "医療提供者向け",
    description:
      "人員を増やしたり事業範囲を広げすぎることなく、価格透明性を効果的に活用し、競争優位を築きましょう。",
  ...
  },
  {
    title: "支払者向け",
    description:
      "法規制や要件を先取りしつつ、価値に基づいたケアの意思決定を推進し、持続可能で効果的な医療サービスを実現しましょう。",
  ...
  },
  {
    title: "雇用者向け",
    description:
      "透明性のある製品を活用して、医療プランを賢く選択するための知識と力を手に入れましょう。",
  ...
  },
  {
    title: "ライフサイエンス向け",
    description:
      "最も多忙なCEOから最も几帳面なデータサイエンティストまで活用できるデータを駆使し、商業戦略を革新しましょう。",
